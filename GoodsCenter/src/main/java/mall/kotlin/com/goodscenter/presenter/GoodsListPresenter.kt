...
class GoodsListPresenter @Inject constructor() : BasePresenter<GoodsListView>() {
    ...
    fun getGoodsList(categoryId: Int, pageNo: Int) {
        ...
        mView.showLoading()
        goodsService.getGoodsList(categoryId,pageNo).execut(object : BaseSubscriber<MutableList<Goods>?>(mView) {
    ...
    fun getGoodsListByKeyword(keyword: String, pageNo: Int) {
        ...
        mView.showLoading()
        goodsService.getGoodsListByKeyword(keyword,pageNo).execut(object : BaseSubscriber<MutableList<Goods>?>(mView) {
            override fun onNext(t: MutableList<Goods>?) {
                mView.onGetGoodsListResult(t)
            }
        }, lifecycleProvider)
