...
class CartListPresenter @Inject constructor() : BasePresenter<CartListView>() {
    ...
    fun getCartList() {
        ...
        mView.showLoading()
        cartService.getCartList().execut(object : BaseSubscriber<MutableList<CartGoods>?>(mView) {
    ...
    fun deleteCartList(list: List<Int>) {
        ...
        mView.showLoading()
        cartService.deleteCartList(list).execut(object : BaseSubscriber<Boolean>(mView) {
    ...
    fun submitCart(list: MutableList<CartGoods>, totalPrice: Long) {
        ...
        mView.showLoading()
        cartService.submitCart(list,totalPrice).execut(object : BaseSubscriber<Int>(mView) {
