...
class OrderListPresenter @Inject constructor() : BasePresenter<OrderListView>() {
    ...
    fun getOrderList(orderStatus: Int) {
        ...
        mView.showLoading()
        orderService.getOrderList(orderStatus).execut(object : BaseSubscriber<MutableList<Order>?>(mView) {
    ...
    fun confirmOrder(orderId: Int) {
        ...
        mView.showLoading()
        orderService.confirmOrder(orderId).execut(object : BaseSubscriber<Boolean>(mView) {
    ...
    fun cancelOrder(orderId: Int) {
        ...
        mView.showLoading()
        orderService.cancelOrder(orderId).execut(object : BaseSubscriber<Boolean>(mView) {
            override fun onNext(t: Boolean) {
