...
class OrderDetailActivity : BaseMvpActivity<OrderDetailPresenter>(), OrderDetailView {
    ...
    private fun initView() {
        ...
        mOrderGoodsRv.setHasFixedSize(true);
        mOrderGoodsRv.setNestedScrollingEnabled(false);
    ...
    private fun loadData() {
        mPersenter.getOrderById(intent.getIntExtra(ProviderConstant.KEY_ORDER_ID,-1))
    }
